...
socat -d -d -d -d TCP-LISTEN:2049,bind=127.0.0.1,fork,reuseaddr,setsockopt-int=1:20:30000000,rcvbuf=65536,sndbuf=65536 VSOCK-CONNECT:3:8004,rcvbuf=65536,sndbuf=65536 &> /tmp/socat.log &
sleep 3
