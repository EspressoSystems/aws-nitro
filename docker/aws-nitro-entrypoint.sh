...
socat -d -d -d -d -b1048576 TCP-LISTEN:2049,bind=127.0.0.1,fork,keepalive,reuseaddr,rcvbuf=32776,sndbuf=32776 VSOCK-CONNECT:3:8004,keepalive,rcvbuf=32776,sndbuf=32776 &> /tmp/socat.log &
sleep 3
