...
socat -d -d -d -d -b24576 TCP-LISTEN:2049,bind=127.0.0.1,fork,keepalive,reuseaddr,rcvbuf=6144,sndbuf=6144 VSOCK-CONNECT:3:8004,keepalive,rcvbuf=6144,sndbuf=6144 &> /tmp/socat.log &
sleep 3
