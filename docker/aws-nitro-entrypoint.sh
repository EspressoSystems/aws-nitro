...
socat -d -d -d -d TCP-LISTEN:2049,bind=127.0.0.1,fork,keepalive,reuseaddr,rcvbuf=4096,sndbuf=4096 VSOCK-CONNECT:3:8004,keepalive,rcvbuf=4096,sndbuf=4096 &> /tmp/socat.log &
sleep 3
