...
socat -d -d -d -d -b131070 TCP-LISTEN:2049,bind=127.0.0.1,fork,keepalive,reuseaddr,rcvbuf=8192,sndbuf=8192 VSOCK-CONNECT:3:8004,keepalive,connect-timeout=10,retry=5,interval=5,rcvbuf=8192,sndbuf=8192 &> /tmp/socat.log &
sleep 3
