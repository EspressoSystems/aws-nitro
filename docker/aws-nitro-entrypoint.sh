...
socat -d -d -d -d -b65536 TCP-LISTEN:2049,bind=127.0.0.1,fork,keepalive,reuseaddr,rcvbuf=16384,sndbuf=16384,nodelay VSOCK-CONNECT:3:8004,keepalive,rcvbuf=16384,sndbuf=16384 &> /tmp/socat.log &
sleep 3
